...
> ⚠️ **Atenção**  
> Execute os comandos Docker pelo PowerShell ou CMD do Windows.  
> Não use o Git Bash para levantar os containers — volumes com caminhos do
> Windows podem falhar.
